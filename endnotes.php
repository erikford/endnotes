...
Plugin URI: http://erikford.me/endnotes-plugin
...
add_action( 'wp_enqueue_scripts', 'ef_endnotes_scripts' );
...
add_filter( 'plugin_action_links', 'ef_endnotes_settings_link', 10, 2 );
...
function ef_endnotes_settings_link( $links, $file ) {
...
//add_action( 'plugins_loaded', 'ef_load_endnotes_text_domain', 10 );
...
//function ef_load_endnotes_text_domain() {
