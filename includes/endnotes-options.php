...
add_action( 'admin_menu', 'ef_endnotes_submenu_page', 10 );
...
function ef_endnotes_submenu_page() {
	...
	add_submenu_page(
		...
		'ef_endnotes_options_cb'               // callback function to render the page HTML
	);
...
function ef_endnotes_options_cb() {
...
<div class="wrap">
	...
	<form id="ef_endnotes_options" action="options.php" method="post">
		<?php
			settings_fields( '_ef_endnotes_settings_group' );
...
add_action( 'admin_init', 'ef_endnotes_admin_init', 10 );
...
function ef_endnotes_admin_init() {

	// register setting
	register_setting(
		'_ef_endnotes_settings_group', // unique option group
		'_ef_endnotes_settings',       // unique option name
		'ef_endnotes_sanitization_cb'  // callback function to sanitize form inputs
	);
	...
	add_settings_section(
		...
		'ef_endnotes_display_settings_section_cb', // callback function to render a description for this section
	...
	add_settings_field(
		...
		'ef_endnotes_header_field_cb',      // callback function to render this form input
	...
	add_settings_field(
		...
		'ef_endnotes_template_field_cb',        // callback function to render this form input
		'endnotes-options',                     // page ID to render this form input
		'endnotes_display_settings_section'     // section ID where this form input should appear
	);
	...
	add_settings_field(
		...
		'ef_endnotes_collapse_field_cb',            // callback function to render this form input
		'endnotes-options',                         // page ID to render this form input
		'endnotes_display_settings_section'         // section ID where this form input should appear
	);
...
function ef_endnotes_display_settings_section_cb() {
...
/**
 * Trailblaze Header Text Field Callback
 *
...
function ef_endnotes_header_field_cb() {

	$options = wp_parse_args(
		get_option(
			'_ef_endnotes_settings' ),
			array(
				'endnotes_header' => '',
			)
		);

	echo "<input type='text' id='endnotes_header' name='_ef_endnotes_settings[endnotes_header]' class='regular-text' value='{$options['endnotes_header']}' />";
	echo "<p class='description'>" . __( 'If left blank, no header will be displayed. No HTML allowed.', 'endnotes' ) . "</p>";
...
function ef_endnotes_template_field_cb() {
...
function ef_endnotes_collapse_field_cb() {
...
function ef_endnotes_sanitization_cb( $input ) {
